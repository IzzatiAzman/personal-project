...
gdjs.LevelCode.GDtxtObjects1= [];
gdjs.LevelCode.GDtxtObjects2= [];
gdjs.LevelCode.GDtxtObjects3= [];
gdjs.LevelCode.GDtxtObjects4= [];
gdjs.LevelCode.GDDisplayLeaderboardObjects1= [];
gdjs.LevelCode.GDDisplayLeaderboardObjects2= [];
gdjs.LevelCode.GDDisplayLeaderboardObjects3= [];
gdjs.LevelCode.GDDisplayLeaderboardObjects4= [];
...
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14802620);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14803972);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14806132);
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSound(runtimeScene, "9e6314ff5ebeaa2ae69347b277085c2aa4458f4ea898cddfe1ebce466a1dbc0d_Jump 1.aac", false, 50, 1);
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14807292);
}
}
if (isConditionTrue_0) {
...
{gdjs.evtTools.sound.playSoundOnChannel(runtimeScene, "082c1a09999a0daa13d707df71ff42fd4f9f732fb751cc1785c1fc66b96fdd5d_Run_04.wav", 1, false, 20, gdjs.randomFloatInRange(0.7, 1.2));
...
}{gdjs.evtTools.sound.playSound(runtimeScene, "362299cbbaf7ecf698844feaa5965154fdb859d4bcaed5ca7890e40be0739723_Run_06.wav", false, 50, 1);
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14835220);
}
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("DisplayLeaderboard"), gdjs.LevelCode.GDDisplayLeaderboardObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.LevelCode.GDDisplayLeaderboardObjects1.length;i<l;++i) {
    if ( gdjs.LevelCode.GDDisplayLeaderboardObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.LevelCode.GDDisplayLeaderboardObjects1[k] = gdjs.LevelCode.GDDisplayLeaderboardObjects1[i];
        ++k;
    }
}
gdjs.LevelCode.GDDisplayLeaderboardObjects1.length = k;
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14831972);
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSound(runtimeScene, "64c620fd92d7491aafad7944ee44d9666dc6493529fbfff90b72ce2718382813_Cha-Cha Ender.aac", false, 50, 1);
...
gdjs.copyArray(runtimeScene.getObjects("txt"), gdjs.LevelCode.GDtxtObjects2);
...
}{for(var i = 0, len = gdjs.LevelCode.GDtxtObjects2.length ;i < len;++i) {
    gdjs.LevelCode.GDtxtObjects2[i].getBehavior("Text").setText((( gdjs.LevelCode.GDtxtEntryObjects2.length === 0 ) ? "" :gdjs.LevelCode.GDtxtEntryObjects2[0].getText()));
}
...
gdjs.LevelCode.GDtxtObjects1.length = 0;
gdjs.LevelCode.GDtxtObjects2.length = 0;
gdjs.LevelCode.GDtxtObjects3.length = 0;
gdjs.LevelCode.GDtxtObjects4.length = 0;
gdjs.LevelCode.GDDisplayLeaderboardObjects1.length = 0;
gdjs.LevelCode.GDDisplayLeaderboardObjects2.length = 0;
gdjs.LevelCode.GDDisplayLeaderboardObjects3.length = 0;
gdjs.LevelCode.GDDisplayLeaderboardObjects4.length = 0;
